...
# Based on https://github.com/enblanco/osx-setup

# Adapted from:
# - https://github.com/mathiasbynens/dotfiles/blob/master/.osx

COMPUTER_NAME="hammond"
...
# Menu bar: disable fast user switching
...
# Minimize on window double click
...
# Tracking speed [slow (0.0) <—-> fast (3.0)]:
...
# Remove folders or custom added apps from the Dock
